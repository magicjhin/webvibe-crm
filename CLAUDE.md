...
| ORM | Prisma 7 + `@prisma/adapter-pg` (см. ADR-019). Generated client в `lib/generated/prisma/`, импорт `@/lib/generated/prisma/client`. URLs в `prisma.config.ts`, не в schema. |
